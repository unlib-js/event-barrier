 ...
 */
export default class EventBarrier extends EventEmitter implements WaiterRegistry<any> {
  private readonly onceWaitersMap: Map<
    /* event */ string,
    /* resolvers, timeout handles, etc. */ OnceWaiter<any>[]
  > = new Map
  private readonly onWaitersMap: Map<
    /* event */ string,
